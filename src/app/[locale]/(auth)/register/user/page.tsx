...
export default function UserRegistrationForm() {
  const t = useScopedI18n('ClientRegistration' as never) as (key: string, vars?: Record<string, any>) => string;
                ...
                <div>
                  ...
                  <div className="space-y-6">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        <h4 className="font-semibold text-white text-lg mb-1">
                          {t('benefits.freeChat.title')}
                        </h4>
                        <p className="text-gray-300">
                          {t('benefits.freeChat.description')}
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        <h4 className="font-semibold text-white text-lg mb-1">
                          {t('benefits.verifiedProfiles.title')}
                        </h4>
                        <p className="text-gray-300">
                          {t('benefits.verifiedProfiles.description')}
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        <h4 className="font-semibold text-white text-lg mb-1">
                          {t('benefits.securePlatform.title')}
                        </h4>
                        <p className="text-gray-300">
                          {t('benefits.securePlatform.description')}
                        </p>
                      </div>
                    </div>
                  </div>
