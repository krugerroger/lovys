    ...
    <>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {visibleAds.map((ad) => (
          <div key={ad.pending_ad_id} className="relative group">
            <div className="absolute -inset-0.5 bg-gradient-to-r from-pink-600 to-purple-600 rounded-2xl blur opacity-0 group-hover:opacity-20 transition duration-1000 group-hover:duration-200" />
      ...
      {!hasMore && ads.length > PAGE_SIZE && (
        <div className="flex flex-col items-center gap-2 mt-10">
          <div className="w-full max-w-xs bg-gray-700 rounded-full h-1.5">
            <div className="bg-gradient-to-r from-pink-500 to-purple-500 h-1.5 rounded-full w-full" />
          </div>
